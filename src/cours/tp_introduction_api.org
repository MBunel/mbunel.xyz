...
#+DESCRIPTION: TP d'introduction à la manipulation d'APIs Web
#+IMAGE: https://mbunel.xyz/static/images/profil_elevation.png

#+BEGIN_abstract
Ce document est la mise en forme d'un notebook utilisé dans le cadre d'une formation d'introduction à la manipulation d'APIs web.
#+END_abstract
