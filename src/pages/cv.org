...
- 2024-… , participation à l'animation de la transversalité [[https://dphn.parisgeo.cnrs.fr/][/« Données et protocoles dans les humanités numériques »/]] de l'UMR [[https://geographie-cites.cnrs.fr/][Géographie-cités]].
...
* Publications
#+Begin_see
Seules les publications mentionées dans cette page sont listées ci-dessous. Pour voir l'entièreté de mes publications vous pouvez consulter la  [[url_for:pages,slug=publications][page suivante]].
#+end_see
#+print_bibliography:
