...
Je suis [[url_for:pages,slug=contact][Mattia Bunel,]] géographe et géomaticien, actuellement ingénieur de recherche EHESS, rattaché à l'[[https://geographie-cites.cnrs.fr][UMR Géographie-cités]] et co-responsable de la [[https://www.ehess.fr/fr/plateforme-géomatique-lehess][plateforme géomatique]] de l'EHESS.
